Public Class RotateText
    ...
    Private Sub WriteVerticalText(ByVal strInput As String, sinHLocation As Single, sinVLocation As Single, intRotate As Integer)
        'WriteVerticalText("Save to config", 37, 120, 270)
        Dim rotate As New RotateText
        rotate.rotationAngle = intRotate
        rotate.quadrantMode = True
        rotate.Font = New System.Drawing.Font("Microsoft Sans Serif", 8.25, FontStyle.Regular, GraphicsUnit.Point)
        'rotate.ForeColor = Color.DarkOrchid
        rotate.Size = New System.Drawing.Size(20, 100)
        rotate.Location = New System.Drawing.Point(sinHLocation, sinVLocation)
        rotate.Text = strInput
        Me.Controls.Add(rotate)
        rotate.BringToFront()
    End Sub
End Class
Public Class Messages
    ...
    Private _strDataError As String = "The database was not found before a timeout expired. Please check your settings or try again."
    ...
    Private _strSettingReload As String = "For most of these settings you need to reload Sequenchel."
